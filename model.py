...
# Load your image
image_path = "input_images/kims.webp"
image = load_img(image_path)  # Make sure to provide the path to your image
...
augmented_images = datagen.flow(
    image, batch_size=1, save_to_dir=save_dir, save_prefix="aug_", save_format="jpeg"
)

# Generate and save a number of augmented images
for i in range(10):  # Specify the number of augmented images to generate
